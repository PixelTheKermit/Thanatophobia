...
public sealed class ExplosionDebugOverlay : Overlay
{
    ...
    private void DrawScreen(OverlayDrawArgs args)
    {
        ...
        Matrix3x2.Invert(SpaceMatrix, out var invSpaceMatrix);
        gridBounds = invSpaceMatrix.TransformBox(args.WorldBounds);
    ...
    private void DrawWorld(in OverlayDrawArgs args)
    {
        ...
        Matrix3x2.Invert(SpaceMatrix, out var spaceMat);
        gridBounds = spaceMat.TransformBox(args.WorldBounds).Enlarged(2);
