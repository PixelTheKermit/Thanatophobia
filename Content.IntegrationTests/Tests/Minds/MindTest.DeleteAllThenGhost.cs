...
public sealed partial class MindTests
{
    ...
    public async Task DeleteAllThenGhost()
    {
        ...
        Assert.That(pair.Client.EntMan.EntityExists(pair.Client.PlayerMan?.LocalEntity));
        ...
        Assert.That(pair.Client.PlayerMan?.LocalEntity, Is.Null);
        ...
        Assert.That(pair.Client.EntMan.EntityExists(pair.Client.PlayerMan?.LocalEntity));
        Assert.That(pair.Server.EntMan.EntityExists(pair.PlayerData?.Mind));
        var xform = pair.Client.Transform(pair.Client.PlayerMan!.LocalEntity!.Value);
