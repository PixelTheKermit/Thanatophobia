...
public sealed class RatvarianLanguageSystem : SharedRatvarianLanguageSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<RatvarianLanguageComponent, StatusEffectRelayEvent<AccentGetEvent>>(OnAccent, before: new[] {typeof(SharedSlurredSystem), typeof(SharedStutteringSystem)});
    }

    private void OnAccent(EntityUid uid, RatvarianLanguageComponent component, StatusEffectRelayEvent<AccentGetEvent> args)
    {
